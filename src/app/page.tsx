...
const projects: ProjectCardProps[] = [
  {
    ...
    solution:
      'Turn any YouTube lecture into interactive study flashcards instantly using Gemini AI.',
    tech: 'Next.js, TypeScript, Tailwind, Gemini API',
    impact:
      'Reduced note-taking time by 80%. Instant study material generation.',
  ...
  },
  {
    title: 'ghfind',
    problem:
      'Searching for specific GitHub Issues or PRs is tedious and unoptimized via UI.',
    solution:
      'A fast, lightweight developer tool that uses the Gemini API to intelligently discover relevant GitHub Issues or PRs.',
  ...
  },
  {
    title: 'Browser4All',
    problem:
      'Phishing and malware threats are evolving faster than standard browsers can catch.',
    solution:
      'AI Secure Browser with real-time phishing & malware protection powered by Gemini AI.',
    tech: 'TypeScript, Gemini AI, Multi-layered Threat Analysis',
    impact:
      'Proactive security. Intelligent download scanning to prevent attacks before they happen.',
    github: 'https://github.com/priyanshuchawda/browser4all',
  },
  {
    title: 'Smart Crowd Navigator',
    problem:
      'Large events suffer from dangerous crowding and inefficient exit timings.',
    solution:
      'Gemini-powered stadium assistant for real-time crowd navigation and timing decisions.',
...
const timelineItems: TimelineItemProps[] = [
  ...
  },
  {
    ...
    description:
      'Built full-stack AI tools, contributed to open-source, and integrated LLMs.',
  },
  {
    year: '2024',
  ...
  },
  {
    ...
    description:
      'Wrote my first lines of code. Discovered a passion for problem-solving.',
  },
];
  ...
  return (
    ...
    >
      <SectionHeading
        ...
        description="Impact-driven engineering. Code is just the medium."
      />
...
function SkillsSection() {
  return (
    ...
    >
      <SectionHeading
        title="Capabilities"
        description="What I can actually DO, not just syntax memorization."
      />

      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <CapabilityCard
          icon={<Cpu className="text-accent h-8 w-8" aria-hidden="true" />}
          title="AI Engineering"
          description="LLMs, RAG, MCP, Prompt Engineering, Vector DBs, Agentic Workflows."
        />
        <CapabilityCard
          icon={<Code className="text-accent h-8 w-8" aria-hidden="true" />}
          title="Software Engineering"
          description="Full-stack apps, Next.js, APIs, Auth, DB Design, Scalable Architecture."
        />
        <CapabilityCard
          icon={<Activity className="text-accent h-8 w-8" aria-hidden="true" />}
          title="Systems & Problem Solving"
          description="DSA, Competitive Programming, Optimization, Architecture Design."
        />
      </div>
    </section>
  );
      ...
      <div className="grid grid-cols-2 gap-6 text-center md:grid-cols-4">
        {[
          ...
          <div key={label} className="space-y-2">
            <div className="text-foreground text-4xl font-black">{value}</div>
